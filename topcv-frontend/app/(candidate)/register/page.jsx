...
export default function CandidateRegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            router.push(`/verify-otp?email=${form.email}&type=verify_email&role=CANDIDATE`);
        } catch (err) {
                ...
                <div className="flex-1 flex flex-col bg-white">
                    <div className="flex-1 flex justify-center items-center px-8 py-12">
                        <div className="w-full max-w-[480px]">
                            ...
                            <h1 className="text-2xl font-bold text-[#00b14f] mb-1">Chào mừng bạn đến với TopCV</h1>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <label htmlFor="agreed" className="text-sm text-gray-600">
                                        ...
                                        <Link href="#" className="text-[#00b14f] hover:underline">
                                            Điều khoản dịch vụ
                                        </Link>{' '}
                                        và{' '}
                                        <Link href="#" className="text-[#00b14f] hover:underline">
